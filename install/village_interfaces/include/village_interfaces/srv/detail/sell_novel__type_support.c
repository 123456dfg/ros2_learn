...
static rosidl_typesupport_introspection_c__MessageMember SellNovel_Request__rosidl_typesupport_introspection_c__SellNovel_Request_message_member_array[2] = {
  {
    "money",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(village_interfaces__srv__SellNovel_Request, image),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, village_interfaces, srv, SellNovel_Request)() {
  SellNovel_Request__rosidl_typesupport_introspection_c__SellNovel_Request_message_member_array[1].members_ =
