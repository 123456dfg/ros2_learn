...
class Init_SellNovel_Request_image
{
public:
  explicit Init_SellNovel_Request_image(::village_interfaces::srv::SellNovel_Request & msg)
  : msg_(msg)
  {}
  ::village_interfaces::srv::SellNovel_Request image(::village_interfaces::srv::SellNovel_Request::_image_type arg)
  {
...
public:
  ...
  {}
  Init_SellNovel_Request_image money(::village_interfaces::srv::SellNovel_Request::_money_type arg)
  {
    msg_.money = std::move(arg);
    return Init_SellNovel_Request_image(msg_);
  }
