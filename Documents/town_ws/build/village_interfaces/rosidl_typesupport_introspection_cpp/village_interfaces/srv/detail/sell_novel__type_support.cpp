...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SellNovel_Request_message_member_array[2] = {
  {
    "money",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(village_interfaces::srv::SellNovel_Request, image),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
